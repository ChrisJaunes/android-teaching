...
public class Exp4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btn_exp4_change = findViewById(R.id.btn_exp4_change);
        btn_exp4_change.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i("Exp4", "Exp3Activity 按下了 btn_exp4_change 按钮，当前线程为" + Thread.currentThread());
